    ...
    <main className="bg-stone-950 selection:bg-rose-500 min-h-screen font-sans text-stone-300 selection:text-white">
      ...
      <article className="space-y-12 mx-auto px-6 pt-28 pb-20 max-w-6xl">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 pt-2">
            <div className="bg-stone-900/60 p-4 rounded-xl">
              <h3 className="mb-1 font-semibold text-white text-base">O que é o Ceni?</h3>
            ...
            <div className="bg-stone-900/60 p-4 rounded-xl">
              <h3 className="mb-1 font-semibold text-white text-base">Papel</h3>
              <p className="text-stone-400 text-sm">
            ...
            <div className="bg-stone-900/60 p-4 rounded-xl">
              <h3 className="mb-1 font-semibold text-white text-base">Público-alvo</h3>
              <p className="text-stone-400 text-sm">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-stone-900/60 p-5 rounded-xl space-y-2 pt-2">
            <h3 className="font-semibold text-white text-lg">O Desafio Técnico</h3>
        ...
        <section className="space-y-6">
          ...
          <div className="gap-4 grid grid-cols-1 sm:grid-cols-3">
            <div className="bg-stone-900/60 p-5 rounded-xl text-center">
              <div className="mb-1 font-bold text-white text-2xl">01</div>
              <div className="mb-2 font-semibold text-rose-500 text-xs uppercase tracking-wider">Passo 1</div>
              <p className="text-stone-400 text-xs">Abrir o plugin no canvas do projeto.</p>
            </div>

            <div className="bg-stone-900/60 p-5 rounded-xl text-center">
              <div className="mb-1 font-bold text-white text-2xl">02</div>
              <div className="mb-2 font-semibold text-rose-500 text-xs uppercase tracking-wider">Passo 2</div>
              <p className="text-stone-400 text-xs">Buscar e escolher o componente desejado.</p>
            </div>

            <div className="bg-stone-900/60 p-5 rounded-xl text-center">
              <div className="mb-1 font-bold text-white text-2xl">03</div>
              <div className="mb-2 font-semibold text-rose-500 text-xs uppercase tracking-wider">Passo 3</div>
              <p className="text-stone-400 text-xs">Clicar no botão de gerar.</p>
            </div>
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="gap-4 grid grid-cols-1 sm:grid-cols-2 pt-2">
            <div className="bg-stone-900/60 p-5 rounded-xl space-y-2">
              <div className="font-semibold text-rose-500 text-xs uppercase tracking-wider">Impacto & Ganho</div>
              <h3 className="font-bold text-white text-xl">Ganho de Produtividade</h3>
              <p className="text-stone-400 text-sm leading-relaxed">
            ...
            <div className="bg-stone-900/60 p-5 rounded-xl space-y-2">
              <div className="font-semibold text-rose-500 text-xs uppercase tracking-wider">Impacto & Ganho</div>
              <h3 className="font-bold text-white text-xl">Visão Sistêmica Aprimorada</h3>
              <p className="text-stone-400 text-sm leading-relaxed">
          ...
          <div className="bg-stone-900/40 p-5 rounded-xl space-y-2">
            <h3 className="font-semibold text-white text-lg">Próximos Passos</h3>
            <p className="text-stone-400 text-sm leading-relaxed">

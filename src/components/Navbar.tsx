    ...
    >
      ...
      <div className="hidden sm:block -mr-[1px] h-12 shrink-0">
        <svg width="64" height="48" viewBox="0 0 64 48" fill="none" className="w-16 h-12">
          <path d="M64 0 H0 C32 0 32 48 64 48 Z" fill="#000" />
        </svg>
      </div>

      {/* Corpo Central da Navbar */}
      <div className="flex flex-row flex-1 justify-between items-center bg-black px-5 pe-5 sm:pe-2 sm:rounded-none rounded-b-xl h-12 transition-all duration-400">
        <Link
          href="/"
      ...
      <div className="hidden sm:block -ml-[1px] h-12 shrink-0">
        <svg width="64" height="48" viewBox="0 0 64 48" fill="none" className="w-16 h-12">
          <path d="M0 0 H64 C32 0 32 48 0 48 Z" fill="#000" />
        </svg>
      </div>
    </motion.nav>
  );
